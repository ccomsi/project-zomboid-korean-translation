...
ProceduralDistributions.list = {
	...
	BurgerKitchenButcher = {
		...
		items = {
			...
			"SeasoningSalt", 8,
			-- Utensils
			"Fleshing_Tool", 10, -- needs to have an inflated spawn chance because of bottleneck issues
			"KitchenKnife", 8,
			"LargeKnife", 1,
			"MeatCleaver", 4,
			-- Misc.
	...
	ButcherTools = {
		...
		items = {
			-- Knives/Blades
			"Fleshing_Tool", 20, -- needs to have an inflated spawn chance because of bottleneck issues
			"Fleshing_Tool", 10,
			"KitchenKnife", 20,
			"KitchenKnife", 10,
			"KnifeFillet", 10,
...
-- 			"SharpBone_Long", 0.1,
	...
	SafehouseArmor = {
		...
		items = {
			...
			"PonchoYellowDOWN", 4,
			-- Misc.
			"Fleshing_Tool", 10, -- used to make leather to make armor
			"Hat_Bandana", 8,
			"Hat_BandanaTINT", 8,
	...
	SafehouseArmor_Mid = {
		...
		items = {
			...
			"Buckle", 8,
			"Cuirass_Magazine", 4,
			"Fleshing_Tool", 20, -- used to make leather to make armor
	...
	SafehouseArmor_Late = {
		...
		items = {
			...
			"Buckle", 8,
			"Cuirass_Magazine", 8,
			"Fleshing_Tool", 50, -- used to make leather to make armor
	...
	SeafoodKitchenButcher = {
		...
		items = {
			...
			"Twine", 10,
			-- Utensils
			"Fleshing_Tool", 10, -- needs to have an inflated spawn chance due to bottleneck issues
			"KitchenKnife", 6,
			"KnifeFillet", 6,
			"LargeKnife", 2,
			"MeatCleaver", 4,
