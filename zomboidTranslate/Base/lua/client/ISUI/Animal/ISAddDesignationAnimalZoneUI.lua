...
function ISAddDesignationAnimalZoneUI:prerender()
    ...
    self:setWidth(math.max(self.width, UI_BORDER_SPACING*2 + 2 +getTextManager():MeasureStringX(UIFont.Small, getText("IGUI_DesignationZone_HowTo"))))
    ...
    addAreaHighlight(startingX, startingY, endX + 1, endY + 1, self.player:getCurrentSquare():getZ(), r, g, b, a)
