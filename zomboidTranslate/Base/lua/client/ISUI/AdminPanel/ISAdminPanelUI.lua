...
function ISAdminPanelUI:updateButtons()
    ...
    self.dbBtn.enable = getPlayer():getRole():haveCapability(Capability.SeeDB);
    enabled = enabled or self.dbBtn.enable
    self.checkStatsBtn.enable = getPlayer():getRole():haveCapability(Capability.CanSeePlayersStats);
    ...
    self.itemListBtn.enable = getPlayer():getRole():haveCapability(Capability.AddItem);
    enabled = enabled or self.itemListBtn.enable
    self.seeOptionsBtn.enable = getPlayer():getRole():haveCapability(Capability.SeePublicServerOptions);
    enabled = enabled or self.seeOptionsBtn.enable
    self.nonpvpzoneBtn.enable = getPlayer():getRole():haveCapability(Capability.CanSetupNonPVPZone);
    enabled = enabled or self.nonpvpzoneBtn.enable
    self.seeFactionBtn.enable = getPlayer():getRole():haveCapability(Capability.FactionCheat);
    enabled = enabled or self.seeFactionBtn.enable
    self.seeRolesBtn.enable = getPlayer():getRole():haveCapability(Capability.RolesRead);
    enabled = enabled or self.seeRolesBtn.enable
    self.seeUsersBtn.enable = getPlayer():getRole():haveCapability(Capability.SeeNetworkUsers);
    enabled = enabled or self.seeUsersBtn.enable
    self.seeSafehousesBtn.enable = getPlayer():getRole():haveCapability(Capability.CanSetupSafehouses);
    enabled = enabled or self.seeSafehousesBtn.enable
    self.safezoneBtn.enable = getPlayer():getRole():haveCapability(Capability.CanSetupSafehouses);
    enabled = enabled or self.safezoneBtn.enable
    self.seeTicketsBtn.enable = getPlayer():getRole():haveCapability(Capability.AnswerTickets);
    enabled = enabled or self.seeTicketsBtn.enable
    self.miniScoreboardBtn.enable = getPlayer():getRole():haveCapability(Capability.GetSteamScoreboard);
    enabled = enabled or self.miniScoreboardBtn.enable
    self.packetCountsBtn.enable = getPlayer():getRole():haveCapability(Capability.GetStatistic);
    enabled = enabled or self.packetCountsBtn.enable
    self.sandboxOptionsBtn.enable = getPlayer():getRole():haveCapability(Capability.SandboxOptions);
    enabled = enabled or self.sandboxOptionsBtn.enable
    self.climateOptionsBtn.enable = getPlayer():getRole():haveCapability(Capability.ClimateManager);
    enabled = enabled or self.climateOptionsBtn.enable
    self.showStatisticsBtn.enable = getPlayer():getRole():haveCapability(Capability.GetStatistic);
    enabled = enabled or self.showStatisticsBtn.enable
    self.pvpLogTool.enable = getPlayer():getRole():haveCapability(Capability.PVPLogTool);
    enabled = enabled or self.pvpLogTool.enable
    self.zoneEditor.enable = getPlayer():getRole():haveCapability(Capability.CanSetupSafehouses) or getPlayer():getRole():haveCapability(Capability.CanSetupNonPVPZone);
